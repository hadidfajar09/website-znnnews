...
<section class="single_page">						
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-sm-8">				
            ...
            @endforeach
            {{ $subcatposts->links('pagination-links') }}
        ...
        <div class="col-md-3 col-sm-4">
            <!-- add-start -->	
            @php
                    $vertical = DB::table('advertisements')->where('type',1)->skip(4)->first();
                    $vertical2 = DB::table('advertisements')->where('type',1)->skip(5)->first();
              @endphp
                <div class="row">
